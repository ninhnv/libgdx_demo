...
public class Physic1Demo implements ApplicationListener{

	private SpriteBatch batch;
	private Sprite sprite;
	private Texture image;
	private TextureAtlas textureAtlas;
	private AtlasRegion character;
	...
	public void create() {
		...
		character2 = new TextureRegion[4];
		character2[0] = (textureAtlas.findRegion("WalkRight_MouthOpen_Red1"));
		character2[1] = (textureAtlas.findRegion("WalkRight_MouthOpen_Red2"));
		character2[2] = (textureAtlas.findRegion("WalkRight_MouthOpen_Red3"));
		character2[3] = (textureAtlas.findRegion("WalkRight_MouthOpen_Red1"));
		
		animation = new Animation(1/4f, character2);
		character = textureAtlas.findRegion("WalkRight_MouthOpen_Red1");
//		image= new Texture("demo/jet.png");
